...
public class SmsUtils {
	...
	static final String accessKeyId = "LTAIrvij88VpkSLa";
	static final String accessKeySecret = "IvBzBzCHQzYmUytfzqbSvhfiNyxP5Z";

	public static SendSmsResponse sendSms(String signName, String templateCode, String phoneNumbers, String code)
